...
Write-Host "Resetting local branch to origin/manan to clear previous commits..."
git reset origin/manan

Write-Host "Unstaging all files..."
git reset

Write-Host "Resolving context.md conflict..."
git add context.md
...
git add backend/README.md backend/test_api.js
